 ...
 * --------------------------------------------------------------------
 */
jQuery.fn.daterangepicker = function(settings,button,pid){
	...
	var options = jQuery.extend({
		...
		prevLinkText: 'Prev',
		doneButtonText: 'Done',
		earliestDate: Date.parse('-5years'), //earliest date allowed 
	...
	rangeInput.keypress(options.onChange);
	...
	function hideRP(){
		if(rp.data('state') == 'open'){ 
			...
			rp.fadeOut(150,	options.onClose); 
		}
	}
	function toggleRP(){
	...
	//wrap and position
	rp.wrap('<div class="ui-daterangepickercontain" id="drp_'+pid+'"></div>');
	if(options.posX){
